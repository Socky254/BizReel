...
export default function PayoutSetupScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Success',
        'Payout details updated. All future withdrawals will be sent to this number.',
      ...
      <View style={styles.content}>
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Funds from the marketplace are sent to this M-Pesa number after the buyer confirms
            receipt.
          </Text>
        </View>
