...
const styles = StyleSheet.create({
  ...
  avatar: { width: 110, height: 110, borderRadius: 40, borderWidth: 3, borderColor: '#1C1C24' },
  placeholder: { backgroundColor: '#0D0D12', justifyContent: 'center', alignItems: 'center' },
  editBadge: {
    position: 'absolute',
    bottom: -5,
    right: -5,
