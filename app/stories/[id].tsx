    ...
    return (
        <View style={styles.container}>
                ...
                <View style={styles.userInfo}>
                    {story.profiles?.avatar_url ? (
                        ...
                        <View style={styles.placeholderAvatar}>
                            <Text style={styles.avatarText}>{(story.profiles?.business_name || 'B').charAt(0)}</Text>
                        </View>
                    )}
                    <View style={{marginLeft: 10}}>
                        <Text style={styles.username}>{story.profiles?.business_name || story.profiles?.username}</Text>
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity onPress={() => router.push({ pathname: '/profile/[id]', params: { id: story.user_id } })}>
