...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingTop: 60, paddingHorizontal: 20, paddingBottom: 15, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)' },
  backBtn: { marginRight: 15, width: 40, height: 40, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 12 },
  searchBar: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#0E0E14', borderRadius: 14, paddingHorizontal: 15, height: 48, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  sectorBar: { paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)', backgroundColor: 'rgba(5, 5, 8, 0.5)' },
  sectorScroll: { paddingHorizontal: 15, gap: 12 },
  sectorBadge: { paddingHorizontal: 18, paddingVertical: 10, borderRadius: 12, backgroundColor: '#15151E', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  activeSector: { backgroundColor: 'rgba(0, 208, 132, 0.1)', borderColor: '#00D084' },
  sectorText: { color: 'rgba(255,255,255,0.3)', fontSize: 11, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1 },
  activeSectorText: { color: '#00D084' },
  input: { flex: 1, color: '#fff', marginLeft: 12, fontSize: 15, fontWeight: '600' },
  trendsContainer: { flex: 1 },
  trendsHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 25, paddingBottom: 15 },
  trendsTitle: { color: '#fff', fontSize: 24, fontWeight: '900', letterSpacing: -0.5 },
  trendsList: { paddingHorizontal: 15 },
  trendItem: { padding: 25, borderRadius: 24, backgroundColor: '#0E0E14', marginBottom: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  trendHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  trendType: { color: '#00D084', fontSize: 10, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 1.5 },
  ...
  resultItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0E0E14', padding: 18, borderRadius: 20, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  imageContainer: { position: 'relative' },
  resultImage: { width: 56, height: 56, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  placeholderImage: { width: 56, height: 56, borderRadius: 16, backgroundColor: '#15151E', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  placeholderText: { color: '#00D084', fontWeight: '900', fontSize: 18 },
  typeBadge: { position: 'absolute', bottom: -4, right: -4, backgroundColor: '#00D084', paddingHorizontal: 6, paddingVertical: 3, borderRadius: 6, borderWidth: 2, borderColor: '#0E0E14' },
