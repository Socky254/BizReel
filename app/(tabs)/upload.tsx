...
const styles = StyleSheet.create({
  selectionContainer: { flex: 1, backgroundColor: '#050508', justifyContent: 'center', padding: 25 },
  selHeader: { marginBottom: 40 },
  selTitle: { color: '#fff', fontSize: 32, fontWeight: '900', letterSpacing: -1 },
  selSubtitle: { color: '#00D084', fontSize: 14, fontWeight: '700', marginTop: 8, textTransform: 'uppercase', letterSpacing: 1 },
  optionsGrid: { gap: 15 },
  optionCard: { backgroundColor: '#0E0E14', padding: 22, borderRadius: 24, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)', flexDirection: 'row', alignItems: 'center' },
  templateSection: { marginVertical: 15 },
  templateHeader: { color: 'rgba(255,255,255,0.3)', fontSize: 10, fontWeight: '900', letterSpacing: 1.5, marginBottom: 15, textTransform: 'uppercase' },
  templateScroll: { paddingLeft: 5 },
  templateItem: { paddingHorizontal: 18, paddingVertical: 12, borderRadius: 14, backgroundColor: '#15151E', marginRight: 12, flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  templateLabel: { color: '#fff', fontSize: 12, fontWeight: '800' },
  liveCard: { borderColor: 'rgba(255, 59, 48, 0.2)' },
  iconBox: { width: 56, height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginRight: 20 },
  optionLabel: { color: '#fff', fontSize: 18, fontWeight: '900', letterSpacing: 0.5 },
  optionDesc: { color: 'rgba(255,255,255,0.4)', fontSize: 12, marginTop: 4, position: 'absolute', left: 98, bottom: 22 },
  mainContainer: { flex: 1, backgroundColor: '#050508' },
  scrollContent: { paddingBottom: 50 },
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 60, paddingHorizontal: 20, marginBottom: 30, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.05)', paddingBottom: 15 },
  ...
  videoPreviewContainer: { width: width * 0.45, aspectRatio: 9/16, backgroundColor: '#0E0E14', marginHorizontal: 20, borderRadius: 20, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', alignSelf: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.5, shadowRadius: 20, elevation: 10 },
  previewVideo: { flex: 1 },
  inputArea: { padding: 25 },
  label: { color: 'rgba(255,255,255,0.3)', fontSize: 11, fontWeight: '900', textTransform: 'uppercase', marginBottom: 12, letterSpacing: 1.5 },
  captionInput: { backgroundColor: '#0E0E14', borderRadius: 20, padding: 20, color: '#fff', fontSize: 16, height: 140, textAlignVertical: 'top', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', marginBottom: 25, fontWeight: '500' },
  categoryInput: { backgroundColor: '#0E0E14', borderRadius: 16, padding: 18, color: '#fff', fontSize: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', fontWeight: '600' },
  liveForm: { padding: 40, alignItems: 'center' },
  liveIconBox: { width: 100, height: 100, borderRadius: 30, backgroundColor: 'rgba(0, 208, 132, 0.05)', justifyContent: 'center', alignItems: 'center', marginBottom: 30, borderWidth: 1, borderColor: 'rgba(0, 208, 132, 0.1)' },
  liveTitle: { color: '#fff', fontSize: 26, fontWeight: '900', textAlign: 'center', letterSpacing: -0.5 },
  liveDesc: { color: 'rgba(255,255,255,0.5)', fontSize: 14, textAlign: 'center', marginTop: 12, lineHeight: 22, fontWeight: '500' },
  liveInput: { width: '100%', backgroundColor: '#0E0E14', borderRadius: 20, padding: 22, color: '#fff', fontSize: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', marginTop: 45, textAlign: 'center', fontWeight: '700' }
});
