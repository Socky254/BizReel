          ...
          <View style={styles.paymentRow}>
            ...
            >
              <Ionicons
                ...
                size={24}
                color={paymentMethod === 'MPESA' ? Colors.primary : Colors.textSecondary}
              />
              <Text
                style={[styles.payText, paymentMethod === 'MPESA' && { color: Colors.primary }]}
              >
                M-Pesa
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              />
              <Text style={[styles.payText, paymentMethod === 'CARD' && { color: Colors.primary }]}>
                Credit Card
              </Text>
            </TouchableOpacity>
          </View>
