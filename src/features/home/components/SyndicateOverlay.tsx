  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.badge}><Text style={styles.badgeText}>WHOLESALE</Text></View>
      </View>

      <Text style={styles.price}>KES {discountPrice} <Text style={styles.unit}>/unit</Text></Text>
      ...
      <View style={styles.footer}>
        <Text style={styles.stats}>{current} / {target} units booked</Text>
...
const styles = StyleSheet.create({
  container: { position: 'absolute', bottom: 100, left: 20, right: 80, backgroundColor: 'rgba(0,0,0,0.85)', padding: 15, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(0,200,83,0.3)' },
  ...
  progressBg: { height: 6, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 3, marginVertical: 12, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: Colors.primary },
  footer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  stats: { color: Colors.textSecondary, fontSize: 11, fontWeight: '700' },
  joinBtn: { backgroundColor: Colors.primary, paddingHorizontal: 15, paddingVertical: 8, borderRadius: 10 },
