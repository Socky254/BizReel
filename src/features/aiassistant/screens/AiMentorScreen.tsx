...
const styles = StyleSheet.create({
    ...
    statusDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: Colors.primary, marginRight: 8 },
    statusText: { color: Colors.primary, fontSize: 10, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 1.5 },
    ...
    typingContainer: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 25, marginBottom: 15 },
    typingText: { color: 'rgba(255,255,255,0.3)', fontSize: 11, marginLeft: 10, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
    inputArea: {
        flexDirection: 'row',
        alignItems: 'flex-end',
