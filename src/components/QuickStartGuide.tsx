  ...
  const steps = [
    {
      id: 1,
      title: 'Identity',
      desc: 'Complete your business profile',
      icon: 'business',
      done: progress >= 40,
      route: '/onboarding',
    },
    {
      id: 2,
      title: 'First Pitch',
      desc: 'Post your first business reel',
      icon: 'videocam',
      done: progress >= 60,
      route: '/(tabs)/create',
    },
    {
      id: 3,
      title: 'Market',
      desc: 'Add a product to your catalog',
      icon: 'cart',
      done: progress >= 80,
    ...
    },
    {
      id: 4,
      title: 'Connect',
      desc: 'Follow 5 local businesses',
      icon: 'people',
      done: progress === 100,
      route: '/search',
    },
            ...
            >
              <View style={[styles.iconBox, step.done && styles.iconBoxDone]}>
                <Ionicons
                  ...
                  size={24}
                  color={step.done ? Colors.primary : '#888'}
                />
              </View>
